...
$.getJSON(url, function(data) {
    ...
    /// JEFFERSON DAILY
    var jeffersonDailyChart = c3.generate({
        bindto: '#daily-chart-jefferson',
        size: {
            height: 300
            //width: 800
        },
        data: {
            ...
            keys: {
                x: 'gsx$date.$t',
                value: ['gsx$jeffersoncasesdaily.$t', 'gsx$jeffersondeathsdaily.$t']
            },
            names: {
                'gsx$jeffersoncasesdaily.$t': 'Daily cases',
                'gsx$jeffersondeathsdaily.$t': 'Daily deaths',
            },
            types: {
                'gsx$jeffersoncasesdaily.$t': 'bar',
                'gsx$jeffersondeathsdaily.$t': 'bar',
            },
            colors: {
                'gsx$jeffersoncasesdaily.$t': 'rgba(8,81,156,.6)',
                'gsx$jeffersondeathsdaily.$t': 'rgba(165,15,21,.6)'
            },
        },
        // padding: {
        //     bottom: 25
    ...
    var jeffersonCumulativeChart = c3.generate({
        bindto: '#cumulative-chart-jefferson',
        size: {
            height: 300
            //width: 800
        },
        data: {
            ...
            keys: {
                x: 'gsx$date.$t',
                value: ['gsx$jeffersoncases.$t', 'gsx$jeffersondeaths.$t']
            },
            names: {
                'gsx$jeffersoncases.$t': 'Total cases',
                'gsx$jeffersondeaths.$t': 'Total deaths',
            },
            types: {
                'gsx$jeffersoncases.$t': 'line',
                'gsx$jeffersondeaths.$t': 'line',
            },
            colors: {
                'gsx$jeffersoncases.$t': 'rgba(8,81,156,.8)',
                'gsx$jeffersondeaths.$t': 'rgba(165,15,21,.8)'
            },
        },
        // padding: {
        //     bottom: 25
    ...
    var countyRateComparisonCases = c3.generate({
        bindto: '#county-rate-comparison-cases-jefferson',
        size: {
            height: 300
            //width: 800
        },
        data: {
            ...
            colors: {
                ...
                'douglasCaseRate': '#bbb',
                'elpasoCaseRate': '#bbb',
                'jeffersonCaseRate': 'rgba(165,15,21,1)',
                'larimerCaseRate': '#bbb',
                'puebloCaseRate': '#bbb',
                'weldCaseRate': '#bbb'
            },
    ...
    var countyRateComparisonDeaths = c3.generate({
        bindto: '#county-rate-comparison-deaths-jefferson',
        size: {
            height: 300
            //width: 800
        },
        data: {
            ...
            colors: {
                ...
                'elpasoDeathRate': '#bbb',
                'jeffersonDeathRate': 'rgba(165,15,21,1)',
