...
$.getJSON(url, function(data) {
    ...
    /// ADAMS DAILY
    var adamsDailyChart = c3.generate({
        bindto: '#daily-chart-adams',
        size: {
            height: 300
            //width: 800
        },
        data: {
            ...
            keys: {
                x: 'gsx$date.$t',
                value: ['gsx$adamscasesdaily.$t', 'gsx$adamsdeathsdaily.$t']
            },
            names: {
                'gsx$adamscasesdaily.$t': 'Daily cases',
                'gsx$adamsdeathsdaily.$t': 'Daily deaths',
            },
            types: {
                'gsx$adamscasesdaily.$t': 'bar',
                'gsx$adamsdeathsdaily.$t': 'bar',
            },
            colors: {
                'gsx$adamscasesdaily.$t': 'rgba(8,81,156,.6)',
                'gsx$adamsdeathsdaily.$t': 'rgba(165,15,21,.6)'
            },
        },
        // padding: {
        //     bottom: 25
    ...
    /// ADAMS CUMULATIVE
    var adamsCumulativeChart = c3.generate({
        bindto: '#cumulative-chart-adams',
        size: {
            height: 300
            //width: 800
        },
        data: {
            ...
            keys: {
                x: 'gsx$date.$t',
                value: ['gsx$adamscases.$t', 'gsx$adamsdeaths.$t']
            },
            names: {
                'gsx$adamscases.$t': 'Total cases',
                'gsx$adamsdeaths.$t': 'Total deaths',
            },
            types: {
                'gsx$adamscases.$t': 'line',
                'gsx$adamsdeaths.$t': 'line',
            },
            colors: {
                'gsx$adamscases.$t': 'rgba(8,81,156,.8)',
                'gsx$adamsdeaths.$t': 'rgba(165,15,21,.8)'
            },
        },
        // padding: {
        //     bottom: 25
    ...
    var countyRateComparisonCases = c3.generate({
        bindto: '#county-rate-comparison-cases-adams',
        size: {
            height: 300
            //width: 800
        },
        data: {
            ...
            colors: {
                'adamsCaseRate': 'rgba(165,15,21,1)',
    ...
    var countyRateComparisonDeaths = c3.generate({
        bindto: '#county-rate-comparison-deaths-adams',
        size: {
            height: 300
            //width: 800
        },
        data: {
            ...
            colors: {
                'adamsDeathRate': 'rgba(165,15,21,1)',
