...
$.getJSON(url, function(data) {
    ...
    /// WELD DAILY
    var weldDailyChart = c3.generate({
        bindto: '#daily-chart-weld',
        size: {
            height: 300
            //width: 800
        },
        data: {
            ...
            keys: {
                x: 'gsx$date.$t',
                value: ['gsx$weldcasesdaily.$t', 'gsx$welddeathsdaily.$t']
            },
            names: {
                'gsx$weldcasesdaily.$t': 'Daily cases',
                'gsx$welddeathsdaily.$t': 'Daily deaths',
            },
            types: {
                'gsx$weldcasesdaily.$t': 'bar',
                'gsx$welddeathsdaily.$t': 'bar',
            },
            colors: {
                'gsx$weldcasesdaily.$t': 'rgba(8,81,156,.6)',
                'gsx$welddeathsdaily.$t': 'rgba(165,15,21,.6)'
            },
        },
        // padding: {
        //     bottom: 25
    ...
    /// WELD CUMULATIVE
    var weldCumulativeChart = c3.generate({
        bindto: '#cumulative-chart-weld',
        size: {
            height: 300
            //width: 800
        },
        data: {
            ...
            keys: {
                x: 'gsx$date.$t',
                value: ['gsx$weldcases.$t', 'gsx$welddeaths.$t']
            },
            names: {
                'gsx$weldcases.$t': 'Total cases',
                'gsx$welddeaths.$t': 'Total deaths',
            },
            types: {
                'gsx$weldcases.$t': 'line',
                'gsx$welddeaths.$t': 'line',
            },
            colors: {
                'gsx$weldcases.$t': 'rgba(8,81,156,.8)',
                'gsx$welddeaths.$t': 'rgba(165,15,21,.8)'
            },
        },
        // padding: {
        //     bottom: 25
    ...
    var countyRateComparisonCases = c3.generate({
        bindto: '#county-rate-comparison-cases-weld',
        size: {
            height: 300
            //width: 800
        },
    ...
    var countyRateComparisonDeaths = c3.generate({
        bindto: '#county-rate-comparison-deaths-weld',
        size: {
            height: 300
            //width: 800
        },
        data: {
            ...
            colors: {
                ...
                'puebloDeathRate': '#bbb',
                'weldDeathRate': 'rgba(165,15,21,1)'
            },
        },
        axis: {
            x: {
