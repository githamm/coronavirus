...
$.getJSON(url, function(data) {
    ...
    /// PUEBLO DAILY
    var puebloDailyChart = c3.generate({
        bindto: '#daily-chart-pueblo',
        size: {
            height: 300
            //width: 800
        },
        data: {
            ...
            keys: {
                x: 'gsx$date.$t',
                value: ['gsx$pueblocasesdaily.$t', 'gsx$pueblodeathsdaily.$t']
            },
            names: {
                'gsx$pueblocasesdaily.$t': 'Daily cases',
                'gsx$pueblodeathsdaily.$t': 'Daily deaths',
            },
            types: {
                'gsx$pueblocasesdaily.$t': 'bar',
                'gsx$pueblodeathsdaily.$t': 'bar',
            },
            colors: {
                'gsx$pueblocasesdaily.$t': 'rgba(8,81,156,.6)',
                'gsx$pueblodeathsdaily.$t': 'rgba(165,15,21,.6)'
            },
        },
        // padding: {
        //     bottom: 25
    ...
    /// PUEBLO CUMULATIVE
    var puebloCumulativeChart = c3.generate({
        bindto: '#cumulative-chart-pueblo',
        size: {
            height: 300
            //width: 800
        },
        data: {
            ...
            keys: {
                x: 'gsx$date.$t',
                value: ['gsx$pueblocases.$t', 'gsx$pueblodeaths.$t']
            },
            names: {
                'gsx$pueblocases.$t': 'Total cases',
                'gsx$pueblodeaths.$t': 'Total deaths',
            },
            types: {
                'gsx$pueblocases.$t': 'line',
                'gsx$pueblodeaths.$t': 'line',
            },
            colors: {
                'gsx$pueblocases.$t': 'rgba(8,81,156,.8)',
                'gsx$pueblodeaths.$t': 'rgba(165,15,21,.8)'
            },
        },
        // padding: {
        //     bottom: 25
    ...
    var countyRateComparisonCases = c3.generate({
        bindto: '#county-rate-comparison-cases-pueblo',
        size: {
            height: 300
            //width: 800
        },
        data: {
            ...
            colors: {
                ...
                'larimerCaseRate': '#bbb',
                'puebloCaseRate': 'rgba(165,15,21,1)',
                'weldCaseRate': '#bbb'
            },
        },
        axis: {
    ...
    var countyRateComparisonDeaths = c3.generate({
        bindto: '#county-rate-comparison-deaths-pueblo',
        size: {
            height: 300
            //width: 800
        },
        data: {
            ...
            colors: {
                ...
                'puebloDeathRate': 'rgba(165,15,21,1)',
                'weldDeathRate': '#bbb'
            },
        },
        axis: {
