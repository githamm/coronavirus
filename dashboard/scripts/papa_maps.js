...
//var tab1Data = "./data/api_tab_1.json";
...
$(document).ready(function() {
    ...
    Papa.parse('https://docs.google.com/spreadsheets/d/' + sheetID + '/export?format=csv&id=' + sheetID + '&gid=' + tabID, {
        ...
        complete: function(results) {
            ...
            for (i = 0; i < output.length; i++) {
                var coords = JSON.parse(output[i].geometry);
                ...
                geojsonCounties.features.push({
                    ...
                    'properties': {
                        ...
                        'number_of_cases': output[i]['number of cases'],
                        'number_of_deaths': output[i]['number of deaths'],
                        'population': output[i].population,
                        'all_vaccinated_pct': output[i]['all vaccinated pct'],
                        'teen_vaccinated_pct': output[i]['teen vaccinated pct'],
                        'elderly_vaccinated_pct': output[i]['elderly vaccinated pct']
                    }
                });
            }
